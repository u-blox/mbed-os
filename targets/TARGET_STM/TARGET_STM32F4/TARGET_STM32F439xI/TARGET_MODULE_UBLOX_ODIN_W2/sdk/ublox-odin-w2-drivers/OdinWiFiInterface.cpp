...
struct wlan_scan_indication_s {
    cbWLAN_ScanIndicationInfo   info;
    bool                        last_result;
};
*/
...
struct odin_wifi_msg_s {
    ...
    union data_t {
        ...
        //struct wlan_scan_indication_s           wlan_scan_indication;
    } data;
};
...
/*
    static void user_connect_timeout(void *callb_context, int tag)
    {
        MBED_ASSERT(callb_context != NULL);

        OdinWiFiInterface *wifi = (OdinWiFiInterface*)callb_context;

        wifi->timeout_connect();
    }
*/
};
...
OdinWiFiInterface::OdinWiFiInterface(): 
    ...
    EMACInterface(OdinWiFiEMAC::get_instance(), OnboardNetworkStack::get_default_instance())
{
    init(false);
}

OdinWiFiInterface::OdinWiFiInterface(bool debug):
    _thread(osPriorityNormal, 4096),
    EMACInterface(OdinWiFiEMAC::get_instance(), OnboardNetworkStack::get_default_instance())
{
    init(debug);
...
//        wait(1); //TODO: why is this needed?
//    }
...
/*
OdinWiFiInterface::OdinWifiState OdinWiFiInterface::entry_link_loss_wait_disconnect(void)
{
    cbRTSL_Status   error_code;
    ...
    return S_STA_LINK_LOSS_WAIT_DISCONNECT;
}
*/
...
void OdinWiFiInterface::handle_wlan_status_started(wlan_status_started_s *start)
{
    ...
    case S_WAIT_START:
        ...
        //There might be a cached request in need to be managed.
        handle_cached_msg();
        break;
...
void OdinWiFiInterface::handle_wlan_status_connection_failure(wlan_status_connection_failure_s *connect_failure)
{
    ...
    case S_STA_CONNECTED:
        ...
        //_state_sta = entry_link_loss_wait_disconnect();
        break;
...
void OdinWiFiInterface::handle_wlan_status_disconnected(void)
{
    ...
    case S_STA_WAIT_DISCONNECT:
        ...
        break;
/*
    case S_STA_LINK_LOSS_WAIT_DISCONNECT:
        if(_debug) {
            printf("MBED_IPSTACK_BRINGDOWN\r\n");
        }
        mbed_ipstack_bringdown(_stack.emac);
        ...
        nsapi_security_t    security)
{
    ...
    case NSAPI_SECURITY_WPA_WPA2:
        ...
        // TODO cache the calculated PSK
        // TODO check if cbWLAN_Util_PSKFromPWD needs to be protected. Call takes long time.
        cbMAIN_driverLock();
...
/*
void OdinWiFiInterface::timeout_user_connect()
{
    _dbg_timeout = 2;
    ...
    msg->type = ODIN_WIFI_MSG_USER_CONNECT_TIMEOUT;
...
/*
// TODO: DO NOT ENABLE UNTIL DFS MASTER IS AVAILABLE (or this is blocked in wlan driver..)
    case cbWLAN_CHANNEL_52:
    case cbWLAN_CHANNEL_56:
    case cbWLAN_CHANNEL_60:
    case cbWLAN_CHANNEL_64:
    case cbWLAN_CHANNEL_100:
    case cbWLAN_CHANNEL_104:
    case cbWLAN_CHANNEL_108:
    case cbWLAN_CHANNEL_112:
    case cbWLAN_CHANNEL_116:
    case cbWLAN_CHANNEL_120:
    case cbWLAN_CHANNEL_124:
    case cbWLAN_CHANNEL_128:
    case cbWLAN_CHANNEL_132:
    case cbWLAN_CHANNEL_136:
    case cbWLAN_CHANNEL_140:
    case cbWLAN_CHANNEL_149:
    case cbWLAN_CHANNEL_153:
    case cbWLAN_CHANNEL_157:
   case cbWLAN_CHANNEL_161:
    case cbWLAN_CHANNEL_165:
*/
        ok = true;
        break;
