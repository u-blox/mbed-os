...
typedef enum targetConfigParams {
    ...
    cbTARGET_CFG_SET_MIN_SCAN_TIME,
    cbTARGET_CFG_GET_MIN_SCAN_TIME,
    cbTARGET_CFG_SET_MAX_SCAN_TIME,
    cbTARGET_CFG_GET_MAX_SCAN_TIME,
    cbTARGET_CFG_SET_SCAN_TYPE,
    cbTARGET_CFG_GET_SCAN_TYPE,
    cbTARGET_CFG_SET_QOS_ENABLE,
    cbTARGET_CFG_GET_QOS_ENABLE,
    cbTARGET_CFG_SET_RTS_THRESHOLD,
    cbTARGET_CFG_GET_RTS_THRESHOLD,
    cbTARGET_CFG_SET_TX_POWER,
    cbTARGET_CFG_GET_TX_POWER,
    cbTARGET_CFG_SET_MAX_PASSIVE_SCAN_TIME,
    cbTARGET_CFG_GET_MAX_PASSIVE_SCAN_TIME,
    cbTARGET_CFG_SET_SCAN_LISTEN_INTERVAL,
    cbTARGET_CFG_GET_SCAN_LISTEN_INTERVAL,
    cbTARGET_CFG_SET_DOT11_SHORT_RETRY_LIMIT,
    cbTARGET_CFG_GET_DOT11_SHORT_RETRY_LIMIT,
    cbTARGET_CFG_SET_DOT11_LONG_RETRY_LIMIT,
    cbTARGET_CFG_GET_DOT11_LONG_RETRY_LIMIT,
    cbTARGET_CFG_SET_AP_DOT11_SHORT_RETRY_LIMIT,
    cbTARGET_CFG_GET_AP_DOT11_SHORT_RETRY_LIMIT,
    cbTARGET_CFG_SET_AP_DOT11_LONG_RETRY_LIMIT,
    cbTARGET_CFG_GET_AP_DOT11_LONG_RETRY_LIMIT,
    cbTARGET_CFG_SET_REMAIN_ON_CHANNEL,
    cbTARGET_CFG_GET_REMAIN_ON_CHANNEL,
    cbTARGET_CFG_SET_STA_TX_RATE_MASK,
    cbTARGET_CFG_GET_STA_TX_RATE_MASK,
    cbTARGET_CFG_SET_FORCE_WORLD_MODE,
    cbTARGET_CFG_GET_FORCE_WORLD_MODE,
    cbTARGET_CFG_SET_TX_PACKET_ACK_TIMEOUT_WD,
    cbTARGET_CFG_GET_TX_PACKET_ACK_TIMEOUT_WD,
    cbTARGET_CFG_SET_CTS_PROTECTION,
    cbTARGET_CFG_GET_CTS_PROTECTION,
    cbTARGET_CFG_SET_HIDDEN_SSID,
    cbTARGET_CFG_GET_HIDDEN_SSID,
    cbTARGET_CFG_SET_AP_STA_INACTIVITY_TIMEOUT,
    cbTARGET_CFG_GET_AP_STA_INACTIVITY_TIMEOUT,
    cbTARGET_CFG_SET_ROAMING_AREA_HYSTERESIS,
    cbTARGET_CFG_GET_ROAMING_AREA_HYSTERESIS,
    cbTARGET_CFG_LAST,                                           
