...
public:
     ...
     */
    emac_mem_buf_t *alloc_heap(uint32_t size, uint32_t align);
     ...
     */
    emac_mem_buf_t *alloc_pool(uint32_t size, uint32_t align);
   ...
   void free(emac_mem_buf_t *buf);
     ...
     */
    uint32_t get_total_len(const emac_mem_buf_t *buf) const;
     ...
     */
    void cat(emac_mem_buf_t *to_buf, emac_mem_buf_t *cat_buf);
     ...
     */
    emac_mem_buf_t *get_next(const emac_mem_buf_t *buf) const;
     ...
     */
    void *get_ptr(const emac_mem_buf_t *buf) const;
     ...
     */
    uint32_t get_len(const emac_mem_buf_t *buf) const;
     ...
     */
    void set_len(emac_mem_buf_t *buf, uint32_t len);
